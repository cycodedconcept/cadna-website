...
export const leadership = [
  ...
  { name: 'Julius Adebowale', title: 'Director of Product', initials: 'JA', image: images.julius, linkedin: null, expertise: ['Product strategy', 'Digital platforms', 'Customer-led innovation'], biography: 'Leads the transformation of ideas and market opportunities into scalable, commercially viable technology products. Connects product strategy, innovation and customer needs to measurable business growth.' },
