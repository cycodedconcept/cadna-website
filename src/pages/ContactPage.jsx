  ...
  return <><SiteNav /><main id="main-content" tabIndex={-1}>
    ...
    <div className={styles.layout}>
      ...
      <aside className={styles.details} aria-labelledby="contact-details-heading">
        ...
        <address><div><small>EMAIL</small><a href={`mailto:${site.email}`}>{site.email}</a></div><div><small>WHATSAPP</small><a href={site.whatsapp}>{site.phone}</a></div><div><small>LAGOS HEADQUARTERS</small><p>{site.address}</p></div></address>
